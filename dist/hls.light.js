...
/* harmony import */ var _controller_subtitle_stream_controller__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/cues */ "./src/empty.js");
...
function timelineConfig() {
  return {
    cueHandler: (_controller_subtitle_stream_controller__WEBPACK_IMPORTED_MODULE_3___default()),
...
var AbrController = /*#__PURE__*/function () {
  ...
  _proto.onFragLoaded = function onFragLoaded(event, _ref) {
    var frag = _ref.frag,
      part = _ref.part;
    if (frag.type === _types_loader__WEBPACK_IMPORTED_MODULE_4__.PlaylistLevelType.MAIN && (0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(frag.sn)) {
      var stats = part ? part.stats : frag.stats;
      var duration = part ? part.duration : frag.duration;
  ...
  _proto.findBestLevel = function findBestLevel(currentBw, minAutoLevel, maxAutoLevel, maxFetchDuration, bwFactor, bwUpFactor) {
    ...
    for (var i = maxAutoLevel; i >= minAutoLevel; i--) {
      ...
      fetchDuration === 0 || !(0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(fetchDuration) || live && !this.bitrateTestDelay || fetchDuration < maxFetchDuration)) {
...
var AudioStreamController = /*#__PURE__*/function (_BaseStreamController) {
  ...
  _proto.loadFragment = function loadFragment(frag, trackDetails, targetBufferTime) {
    ...
    if (this.audioSwitch || fragState === _fragment_tracker__WEBPACK_IMPORTED_MODULE_4__.FragmentState.NOT_LOADED || fragState === _fragment_tracker__WEBPACK_IMPORTED_MODULE_4__.FragmentState.PARTIAL) {
      ...
      } else if (trackDetails.live && !(0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(this.initPTS[frag.cc])) {
    ...
    if (renditionReports) {
      for (var i = 0; i < renditionReports.length; i++) {
        ...
        if (uri === playlistUri.slice(-uri.length)) {
          ...
          if ((0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(msn)) {
            return new _types_level__WEBPACK_IMPORTED_MODULE_1__.HlsUrlParameters(msn, (0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(part) ? part : undefined, _types_level__WEBPACK_IMPORTED_MODULE_1__.HlsSkip.No);
          }
        }
      }
    }
...
var BaseStreamController = /*#__PURE__*/function (_TaskLoop) {
  ...
  _proto.onMediaSeeking = function onMediaSeeking() {
    ...
    this.log("media seeking to " + ((0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(currentTime) ? currentTime.toFixed(3) : currentTime) + ", state: " + state);
  ...
  _proto._doFragLoad = function _doFragLoad(frag, details, targetBufferTime, progressCallback) {
    ...
    if ((0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(frag.sn) && !this.bitrateTest) {
  ...
  _proto.getFwdBufferInfo = function getFwdBufferInfo(bufferable, type) {
    var config = this.config;
    var pos = this.getLoadPosition();
    if (!(0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(pos)) {
      return null;
    }
  ...
  */;
  ...
  _proto.alignPlaylists = function alignPlaylists(details, previousDetails) {
    ...
    var aligned = details.alignedSliding && (0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(slidingStart);
  ...
  _proto.setStartPosition = function setStartPosition(details, sliding) {
    ...
    if (startPosition === -1 || this.lastCurrentTime === -1) {
      ...
      if ((0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(startTimeOffset)) {
...
var BufferController = /*#__PURE__*/function () {
  ...
  _proto.flushBackBuffer = function flushBackBuffer() {
    ...
    if (!(0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(backBufferLength) || backBufferLength < 0) {
      return;
    }
    var currentTime = media.currentTime;
  ...
  _proto.updateMediaElementDuration = function updateMediaElementDuration() {
    ...
    var msDuration = (0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(mediaSource.duration) ? mediaSource.duration : 0;
    if (details.live && hls.config.liveDurationInfinity) {
      // Override duration to Infinity
      _utils_logger__WEBPACK_IMPORTED_MODULE_2__.logger.log('[buffer-controller]: Media Source duration is set to Infinity');
      mediaSource.duration = Infinity;
      this.updateSeekableRange(details);
    } else if (levelDuration > msDuration && levelDuration > mediaDuration || !(0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(mediaDuration)) {
  ...
  _proto.removeExecutor = function removeExecutor(type, startOffset, endOffset) {
    ...
    var mediaDuration = (0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(media.duration) ? media.duration : Infinity;
    var msDuration = (0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(mediaSource.duration) ? mediaSource.duration : Infinity;
  ...
  _createClass(CapLevelController, [{
    ...
    get: function get() {
      ...
      if (!this.hls.config.ignoreDevicePixelRatio) {
        try {
          pixelRatio = Math.max(self.devicePixelRatio, this.hls.config.minDevicePixelRatio);
        } catch (e) {
          /* no-op */
        }
      }
...
function findFragmentByPDT(fragments, PDTValue, maxFragLookUpTolerance) {
  if (PDTValue === null || !Array.isArray(fragments) || !fragments.length || !(0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(PDTValue)) {
    return null;
  }
...
var ID3TrackController = /*#__PURE__*/function () {
  ...
  _proto.onLevelUpdated = function onLevelUpdated(event, _ref2) {
    ...
    if (ids.length === 0 || !(0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(lastFragment === null || lastFragment === void 0 ? void 0 : lastFragment.programDateTime)) {
      return;
    }
    if (!this.id3Track) {
      this.id3Track = this.createTrack(this.media);
...
function updateFromToPTS(fragFrom, fragTo) {
  ...
  if ((0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(fragToPTS)) {
...
function updateFragPTSDTS(details, frag, startPTS, endPTS, startDTS, endDTS) {
  ...
  if ((0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(fragStartPts)) {
    // delta PTS between audio and video
    var deltaPTS = Math.abs(fragStartPts - startPTS);
    if (!(0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(frag.deltaPTS)) {
...
function mergeDetails(oldDetails, newDetails) {
  ...
  mapFragmentIntersection(oldDetails, newDetails, function (oldFrag, newFrag) {
    ...
    if ((0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(oldFrag.startPTS) && (0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(oldFrag.endPTS)) {
...
var StreamController = /*#__PURE__*/function (_BaseStreamController) {
  ...
  */;
  ...
  _proto.onMediaSeeked = function onMediaSeeked() {
    ...
    if ((0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(currentTime)) {
  ...
  _proto._handleTransmuxComplete = function _handleTransmuxComplete(transmuxResult) {
    ...
    if (initSegment) {
      ...
      if ((0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(initPTS)) {
        this.initPTS[frag.cc] = initPTS;
  ...
  _createClass(StreamController, [{
    ...
    get: function get() {
      ...
      if (media) {
        ...
        if (frag && (0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(currentTime) && (0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(frag.programDateTime)) {
...
var BaseAudioDemuxer = /*#__PURE__*/function () {
  ...
  _proto.demux = function demux(data, timeOffset) {
    ...
    if (this.basePTS === null || this.frameIndex === 0 && (0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(timestamp)) {
...
var initPTSFn = function initPTSFn(timestamp, timeOffset, initPTS) {
  if ((0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(timestamp)) {
    return timestamp * 90;
  }
      ...
      if (emsgs) {
        emsgs.forEach(function (data) {
          ...
          if (emsgSchemePattern.test(emsgInfo.schemeIdUri)) {
            var pts = (0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(emsgInfo.presentationTime) ? emsgInfo.presentationTime / emsgInfo.timeScale : timeOffset + emsgInfo.presentationTimeDelta / emsgInfo.timeScale;
...
var DateRange = /*#__PURE__*/function () {
  function DateRange(dateRangeAttr, dateRangeWithSameId) {
    ...
    if (DateRangeAttribute.END_DATE in this.attr) {
      ...
      if ((0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(endDate.getTime())) {
  ...
  _createClass(DateRange, [{
    ...
    get: function get() {
      if (DateRangeAttribute.DURATION in this.attr) {
        ...
        if ((0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(duration)) {
          return duration;
        }
    ...
    key: "isValid",
    get: function get() {
      return !!this.id && !this._badValueForSameId && (0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(this.startDate.getTime()) && (this.duration === null || this.duration >= 0) && (!this.endOnNext || !!this.class);
    }
  }]);
  return DateRange;
}();
...
function createLoaderContext(frag, part) {
  ...
  if ((0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(start) && (0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(end)) {
...
var Fragment = /*#__PURE__*/function (_BaseSegment) {
  ...
  _createClass(Fragment, [{
    ...
    get: function get() {
      ...
      if (!(0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(this.programDateTime)) {
        return null;
      }
      var duration = !(0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(this.duration) ? 0 : this.duration;
  ...
  _createClass(LevelDetails, [{
    ...
    get: function get() {
      if (this.fragments.length) {
        return (0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(this.fragments[this.fragments.length - 1].programDateTime);
      }
      return false;
    }
  }, {
  ...
  M3U8Parser.parseLevelPlaylist = function parseLevelPlaylist(string, baseurl, id, type, levelUrlId) {
    ...
    while ((result = LEVEL_PLAYLIST_REGEX_FAST.exec(string)) !== null) {
      ...
      if (duration) {
        ...
        // url
        if ((0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(frag.duration)) {
          frag.start = totalduration;
          if (levelkey) {
          ...
          case 'SKIP':
            {
              ...
              if ((0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(skippedSegments)) {
...
function assignProgramDateTime(frag, prevFrag) {
  ...
  if (!(0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(frag.programDateTime)) {
...
var PlaylistLoader = /*#__PURE__*/function () {
  ...
  _proto.handleTrackOrLevelPlaylist = function handleTrackOrLevelPlaylist(response, stats, context, networkDetails) {
    ...
    var id = context.id,
      ...
      type = context.type;
    var url = getResponseUrl(response, context);
    var levelUrlId = (0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(id) ? id : 0;
    var levelId = (0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(level) ? level : levelUrlId;
...
var MP4Remuxer = /*#__PURE__*/function () {
  ...
  _proto.generateIS = function generateIS(audioTrack, videoTrack, timeOffset) {
    ...
    var tracks = {};
    var computePTSDTS = !(0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(this._initPTS);
...
var PassThroughRemuxer = /*#__PURE__*/function () {
  ...
  _proto.remux = function remux(audioTrack, videoTrack, id3Track, textTrack, timeOffset) {
    ...
    if (!(0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(lastEndTime)) {
...
function alignDiscontinuities(lastFrag, details, lastLevel) {
  if (shouldAlignOnDiscontinuities(lastFrag, lastLevel, details)) {
    ...
    if (referenceFrag && (0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(referenceFrag.start)) {
...
function alignPDT(details, lastDetails) {
  ...
  if (sliding && (0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(sliding)) {
...
var FetchLoader = /*#__PURE__*/function () {
  ...
  _proto.load = function load(context, config, callbacks) {
    ...
    self.fetch(this.request).then(function (response) {
      ...
      if (onProgress && (0,_home_grbla_screen9_git_outside_hls_js_screen9_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__.isFiniteNumber)(config.highWaterMark)) {
